...
static void keyCallback(GLFWwindow *wind, int key, int sc, int action, int mods) {
...
static void mouseButtonCallback(GLFWwindow *wind, int button, int action, int mod) {
...
int loadFile(const char* filename) {
    ...
    if (is) {
        ...
        int *sortBuffer = new int[length/3]; //convert each 3 byte pair to an int to sort them
